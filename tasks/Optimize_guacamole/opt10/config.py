...
config={
        ...
        'log_path':'tasks/Optimize_guacamole/opt10',
        ...
        #"pretrain_path":"tasks/Optimize_guacamole/opt10/model/pretrain.model.ckpt",
        "crit_prestep":100,
        "train_epoch":100,
        "pretrain_epoch":100,
        ...
        "entropy_beta":0.5,
        "pre_lr":5e-4,
        "init_population":make_initpop("tasks/Optimize_guacamole/opt10/topk.txt" , benchmark, 512),
        "top_train":True
        }
